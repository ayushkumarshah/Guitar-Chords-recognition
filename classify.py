...
canvas.create_window(720, 170, window=record, height=25, width=80)

clear=Button(canvas, text='Clear',font="Times 15 bold", command=restart_program)
canvas.create_window(1000, 570, window=clear, height=25, width=80)

classify=Button(canvas, text='Classify',font="Times 15 bold", command=classify)
canvas.create_window(880, 170, window=classify, height=25, width=100)

play=Button(canvas, text='Play',font="Times 15 bold", command=play)
canvas.create_window(800, 170, window=play, height=25, width=80)
